...
// HIDE TILE
      ...
      // FEEDBACK LIE
      feedbackLieActive : false,
      feedbackLieUsed : false,
      // Bet Miss
      betMissActive : false,
      betMissUsed : false,
      betMissNumber : null,
      ...
      // SECRET THEMES (one-shot guesser reward). secretThemesRevealed is
      // the list of category labels read off the secret at the moment the
      // card was picked -- never recomputed, so it does not follow a later
      // New secret. Both reset at the round transition.
      secretThemesUsed: false,
      secretThemesRevealed: null,
...
function createInitialState() {
  ...
  // --- MODE / MATCH CONTROL (NEW, GENERIC) ---
    ...
    ranked : false,
    shuffle: false,
    gameMode: "powerChoice", // power-choice-mode-v2.2
    draftMode: false,
    ...
    powerChoice: null, // power-choice-mode-v2.2
    _pendingPowerEvents: [],
