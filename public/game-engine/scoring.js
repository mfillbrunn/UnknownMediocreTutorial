...
// of order (e.g. only position 3 known). Called (via window) by
// preview.js's predictFeedbackIncomplete for the Secretkeeper's live
// preview of a partly typed secret.
...
if (typeof window !== "undefined") {
  ...
  window.scoreGuessIncomplete = scoreGuessIncomplete;
}
